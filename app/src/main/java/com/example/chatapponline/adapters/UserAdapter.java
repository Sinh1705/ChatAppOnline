...
import com.example.chatapponline.databinding.ItemContainerUserBinding;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserViewHolder>{
    ...
    class UserViewHolder extends RecyclerView.ViewHolder{
        ...
        void setUserData(User user){
            ...
            binding.getRoot().setOnClickListener(v-> userListener.onUserClicked(user)); //khi người dùng thực hiện click vào item trong adapter
        }
    }
